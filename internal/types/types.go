// Package types holds the core RLM domain types that are shared across
// packages. Keeping them in a leaf package avoids import cycles between the
// client, handler, and orchestrator packages.
package types
